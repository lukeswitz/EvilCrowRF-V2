...
#include "FS.h"
#include "SD.h"
#include "esp_task_wdt.h"  // Include this for ESP32
...
const char *ssid = "ECRF-Hobby-Board";  // Enter your SSID here
const char *password = "123456789";    //Enter your Password here
const int wifi_channel = 7;           //Enter your preferred Wi-Fi Channel
...
void force_reset() {
  ...
  esp_task_wdt_init(&wdt_config);  // Initialize watchdog with config structure
...
void loop() {
  ...
  if (jammer_tx == "1") {
    ...
    // Ensure array size and bounds
    int jammer_size = sizeof(jammer) / sizeof(jammer[0]);
